...
// A enum e a data class são importadas de Challenge.kt (assumindo que estão lá)

// Lista de desafios mockados com o novo sistema de recompensas
val sampleChallenges = mutableStateListOf(
    ...
    TinyWinChallenge(
        ...
        xp = 20,
        coins = 15,
        diamonds = 1, // Desafio mais difícil, recompensa um diamante!
        category = ChallengeCategory.SAUDE,
        imageResId = null,
        isFavorite = false,
        quantifiable = false
